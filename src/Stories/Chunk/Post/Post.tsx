...
import { textBold, time } from 'Global/Mixins'
    ...
    return (
        <div css={C.container}>
            ...
            <VisibilitySensor onChange={handleVisibility}>
                <Link to={`c/${community.public_id}/p/${public_id}`} css={{ all: 'unset' }} >
                    ...
                    <div css={C.inner}>
                        ...
                        {!(tags && tags.some((obj: any) => filter.includes(obj?.public_id))) && <section>
