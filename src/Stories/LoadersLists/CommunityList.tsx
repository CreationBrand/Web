...
const CommunityList = () => {
    ...
    return <div css={C.container}>
        <Input onChange={handleSearch} value={value} fullWidth disableUnderline 
        placeholder="Search..."
...
const Node = ({ node, style, dragHandle, ...props }: any) => {
    ...
    if (node.data.type === 'group') return (<div onClick={handleOpenClose} css={C.group}>

        {!node.isOpen ? <KeyboardArrowUpRoundedIcon sx={{ height: '20px' }}
    ...
    return (
        <div css={C.container} ref={dragHandle} >
            ...
            <NavButton label={node.data.title} avatar_id={node.data.public_id}
